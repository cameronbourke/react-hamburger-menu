...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hamburgerMenu = __webpack_require__(/*! ../src/hamburger-menu */ 159);
	...
	var App = (function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function handleClick(id) {
				...
				this.setState({
					open: [].concat(_toConsumableArray(open.slice(0, id)), [!open[id]], _toConsumableArray(open.slice(id + 1)))
				});
			}
		}, {
			key: 'render',
